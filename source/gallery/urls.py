...
urlpatterns = [
    ...
    path('photos/<int:pk>/token/generate/', views.GeneratePhotoToken.as_view(), name='photo_token_generate'),
    path('photos/token/<uuid:token>', views.PhotoTokenDetailView.as_view(), name='photo_token_detail'),
